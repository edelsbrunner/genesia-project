...
bool InitInstance( HINSTANCE hInstance, int nCmdShow )
{
 ...
 SYSTEMTIME SysTime;
	...
	wsprintf(cTitle, "Helbreath Dragon Game Server V%d.%d (Executed at %.2d:%.2d on %d/%.2d)", UPPER_VERSION, LOWER_VERSION, SysTime.wHour, SysTime.wMinute, SysTime.wDay, SysTime.wMonth);
